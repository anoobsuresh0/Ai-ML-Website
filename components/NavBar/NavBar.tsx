...
const NavBar = () => {
  return (
    <div className="w-screen flex justify-between items-center h-[80px] bg-black text-white lg:px-24 sm:px-4 sticky top-0 z-50">
      <div className="flex justify-between items-center w-full space-x-10">
        ...
        <Link href="/blog" className="flex justify-center items-center gap-4">
          <h3 className="font-neueMachina sm:hidden lg:block md:block">Blog</h3>
          <img
            src={BlogLogo.src}
            alt="blog"
